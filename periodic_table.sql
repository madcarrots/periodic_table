...
--
-- Name: elements fk_atomic; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--
...
ALTER TABLE ONLY public.properties
    ADD CONSTRAINT fk_atomic FOREIGN KEY (atomic_number) REFERENCES public.elements(atomic_number) ON DELETE CASCADE;
